...
public class controllerfaçade2 {
	 ...
	 * @version 1.0
	 */
	public class controllerfaçade2 implements IOrderPerformer, IBoulderDashController {

	  /** The view. */
	  private final view.IView view;

	  /** The model. */
	  private final model.IModel model;
	   ...
	   *          the model
	   */
	  public ControllerFacade(final view.IView view, final model.IModel model) {
	    super();
	    this.view = view;
	    this.model = model;
	  }
	  ...
	  public void start() throws InterruptedException {
	    ...
	    while (this.getModel().getMyCharacter().isAlive()) {
	      ...
	      this.getClass().followMyCharacter();
	 ...
	 */
	  ...
	  @Override
	  public final void orderPerform(final order userOrder) throws IOException {
	  ...
	  private void setStackOrder(order newOrder) {
